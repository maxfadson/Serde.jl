...
function yaml_value!(buf::IOBuffer, f::Function, val::AbstractString; kw...)::Nothing
...
function yaml_value!(buf::IOBuffer, f::Function, val::Bool; kw...)::Nothing
    return print(buf, uppercasefirst(string(val)))
end

function yaml_value!(buf::IOBuffer, f::Function, val::Number; kw...)::Nothing
    return isnan(val) || isinf(val) ? print(buf, YAML_NULL) : print(buf, val)
end
...
function yaml_value!(buf::IOBuffer, f::Function, val::Pair; l::Int64, kw...)::Nothing
    print(buf, indent(l))
    yaml_value!(buf, f, first(val); l = l + (l != -1), kw...)
    print(buf, ": ")
    yaml_value!(buf, f, last(val); l = l + (l != -1), kw...)
    return print(buf)
end

function yaml_value!(buf::IOBuffer, f::Function, val::AbstractDict; l::Int64, kw...)::Nothing
    next = iterate(val)
    print(buf, isroot ? "" : indent(l))
    global isroot = false
    while next !== nothing
        (k, v), index = next
        yaml_value!(buf, f, k; l = l + (l != -1), kw...)
        print(buf, any(map(t -> isa(v,t), INDENT_TYPES)) ? ":" : ": ")
        yaml_value!(buf, f, v; l = l + (l != -1), kw...)
...
function yaml_value!(buf::IOBuffer, f::Function, val::AbstractVector; l::Int64, kw...)::Nothing
    next = iterate(val)
    print(buf, indent(l))
    while next !== nothing
        item, index = next
        print(buf, "- ")
        yaml_value!(buf, f, item; l = l + (l != -1), kw...)
        next = iterate(val, index)
        next === nothing || print(buf, indent(l))
    end
    return print(buf)
...
function yaml_value!(buf::IOBuffer, f::Function, val::Tuple; l::Int64, kw...)::Nothing
    next = iterate(val)
    print(buf, indent(l))
    while next !== nothing
        item, index = next
...
function yaml_value!(buf::IOBuffer, f::Function, val::NamedTuple; l::Int64, kw...)::Nothing
    names = keys(val)
    print(buf, indent(l))
    next = iterate(names)
    ...
    while next !== nothing
        ...
        yaml_value!(buf, f, item; l = l + (l != -1), kw...)
        print(buf, ": ")
        yaml_value!(buf, f, item_value; l = l + (l != -1), kw...)
...
function yaml_value!(buf::IOBuffer, f::Function, val::AbstractSet; l::Int64, kw...)::Nothing
    next = iterate(val)
    print(buf, indent(l))
    while next !== nothing
        item, index = next
...
function yaml_value!(buf::IOBuffer, f::Function, val::T; l::Int64, kw...)::Nothing where {T}
    next = iterate(f(T))
    print(buf, isroot ? "" : indent(l))
    global isroot = false
