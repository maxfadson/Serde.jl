...
[![docs](https://img.shields.io/badge/docs-blue.svg)](https://bhft.gitlab.io/Serde.jl)
[![pipeline status](https://gitlab.com/bhft/Serde.jl/badges/master/pipeline.svg)](https://gitlab.com/bhft/Serde.jl/-/commits/master)
[![coverage report](https://gitlab.com/bhft/Serde.jl/badges/master/coverage.svg)](https://gitlab.com/bhft/Serde.jl/-/commits/master)
[![version](https://gitlab.com/bhft/Serde.jl/-/jobs/artifacts/master/raw/version.svg?job=badge-version)](https://gitlab.com/bhft/Serde.jl/-/blob/master/Project.toml)
...
julia> juliacon = deser_xml(JuliaCon, csv)
JuliaCon("JuliaCon 2024", Date("2024-07-09"), Date("2024-07-13"))
```

If you want to see more deserialization options, then take a look at the corresponding [section](https://bhft.gitlab.io/Serde.jl/pages/extended_de/) of the documentation
...
If you want to see more serialization options, then take a look at the corresponding [section](https://bhft.gitlab.io/Serde.jl/pages/extended_ser/) of the documentation
...
More information can be found in the [documentation](https://bhft.gitlab.io/Serde.jl/pages/utils/#Serde.@serde)
...
Contributions to Serde are welcome! If you encounter a bug, have a feature request, or would like to contribute code, please open an issue or a pull request on GitLab.
